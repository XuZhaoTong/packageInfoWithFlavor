  ...
  public void onMethodCall(MethodCall call, Result result) {
    try {
      if (call.method.equals("getAll")) {
        ...
        ApplicationInfo appInfo = pm.getApplicationInfo(applicationContext.getPackageName(), PackageManager.GET_META_DATA);
        ...
        map.put("channelName", String.valueOf(appInfo.metaData.getString("CHANNEL_NAME")));
        result.success(map);
      } else {
